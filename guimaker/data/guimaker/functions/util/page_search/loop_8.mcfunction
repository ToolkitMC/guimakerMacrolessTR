...
execute if score $page_search_i gm.Values matches 0 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[0].page_number
...
execute if score $page_search_i gm.Values matches 1 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[1].page_number
...
execute if score $page_search_i gm.Values matches 2 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[2].page_number
...
execute if score $page_search_i gm.Values matches 3 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[3].page_number
...
execute if score $page_search_i gm.Values matches 4 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[4].page_number
...
execute if score $page_search_i gm.Values matches 5 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[5].page_number
...
execute if score $page_search_i gm.Values matches 6 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[6].page_number
...
execute if score $page_search_i gm.Values matches 7 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[7].page_number
...
execute if score $page_search_i gm.Values matches 8 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[8].page_number
...
execute if score $page_search_i gm.Values matches 9 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[9].page_number
...
execute if score $page_search_i gm.Values matches 10 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[10].page_number
...
execute if score $page_search_i gm.Values matches 11 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[11].page_number
...
execute if score $page_search_i gm.Values matches 12 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[12].page_number
...
execute if score $page_search_i gm.Values matches 13 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[13].page_number
...
execute if score $page_search_i gm.Values matches 14 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[14].page_number
...
execute if score $page_search_i gm.Values matches 15 if score $found_page_idx gm.Values matches -1 store result score $check_page gm.Values run data get storage barden:gui.all GUI[8].PAGES[15].page_number
