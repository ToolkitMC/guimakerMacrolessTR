...
execute unless entity @a[tag=gm.editing_page] run data modify storage guimaker:input cmd set from entity @s data.PAGE.INIT[{Slot:9b}].tag.BUTTON_INFO.function_file
