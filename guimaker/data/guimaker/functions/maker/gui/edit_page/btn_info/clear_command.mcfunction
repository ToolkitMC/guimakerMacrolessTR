#> command alanını temizle — $target_slot show_XX tarafından set edilmiş olmalı
...
function guimaker:util/ops/clear_btn_command
...
tellraw @s {"text":">> command temizlendi!","color":"green"}
