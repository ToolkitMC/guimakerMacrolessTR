...
execute if score $GUIS_OWNED gm.Values matches 0 run function guimaker:maker/gui/add_page/list/no_entry
...
execute if score $GUIS_OWNED gm.Values matches 1.. run function guimaker:maker/gui/add_page/list/2
tellraw @s {"text":"-------------------------------","color":"#FFDF8D"}
